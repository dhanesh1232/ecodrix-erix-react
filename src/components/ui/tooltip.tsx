  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          "erix-z-50 erix-w-fit erix-origin-(--radix-tooltip-content-transform-origin) erix-animate-in erix-rounded-md erix-bg-foreground erix-px-3 erix-py-2 erix-text-xs erix-text-balance erix-text-background erix-fade-in-0 erix-zoom-in-95 data-[side=bottom]:erix-slide-in-from-top-2 data-[side=left]:erix-slide-in-from-right-2 data-[side=right]:erix-slide-in-from-left-2 data-[side=top]:erix-slide-in-from-bottom-2 data-[state=closed]:erix-animate-out data-[state=closed]:erix-fade-out-0 data-[state=closed]:erix-zoom-out-95",
          className,
        )}
        {...props}
      >
